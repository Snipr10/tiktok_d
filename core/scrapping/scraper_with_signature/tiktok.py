...
class TikTokApi:
    ...
    def search_for_hashtags(self, search_term, count=28, **kwargs) -> list:
        ...
        :param search_term: The string to search by.
        :param count: The number of posts to return.
        :param proxy: The IP address of a proxbyHashtagy to make requests from.
        """
    ...
    def getMusicObjectFull(self, id, **kwargs):
        ...
        r = requests.get("https://www.tiktok.com/music/-{}".format(id), headers={
            ...
            "Cookie": "s_v_web_id=" + kwargs.get("custom_verifyFp",
                                                 "verify_khgp4f49_V12d4mRX_MdCO_4Wzt_Ar0k_z4RCQC9pUDpX"),
        }, proxies=self.__format_proxy(kwargs.get("proxy", None)))
        t = r.text
        j_raw = \
        t.split('<script id="__NEXT_DATA__" type="application/json" crossorigin="anonymous">')[1].split("</script>")[0]
